  ...
  return (
    ...
    <MDBContainer fluid className="min-vh bkgrd">
      ...
      <div className="d-flex justify-content-center flex-column flex-sm-row">
        ...
        <MDBCardImage
          variant="top"
          className="img-fluid rounded-pill order-sm-1 card-picture my-5 mx-auto mx-sm-3"
          src={headshot}
          alt="headshot"
        />
          ...
          <MDBCardBody>
            ...
            <MDBCardText>
              <p>
                ...
                Front End Developer Certified from Skillcrush 18 years of
                experience in the tech industry 20+ years of professional career
                experience
              </p>
              <p>
                👩🏻‍💻🛠️🚀I got into coding when I was a teenager and am now
                returning to my roots in all things nerdy by acquiring my{" "}
                <code>Full Stack MERN certification through UC Berkeley</code>{" "}
                and my{" "}
                <code>Front End Dev certification through Skillcrush</code>.
              </p>
              <p>
                📅📝👩‍💼 My background is in project management. I've been working
                in operations for over 8 years.
              </p>
              <p>
                🛼✌️🗳️Outside of professional endeavors I like to play roller
                derby with Charlotte Roller Derby, coach women and girls with
                Foundation For Girls, and contribute to my local community by
